...
public class ProspectoServiceImpl implements ProspectoService{
    ...
    @Override
    public ArrayList<ProspectoDto> getAllProspectos(final int pageNo, final int pageSize, final String sortBy)
    {
        Pageable paging = PageRequest.of(pageNo, pageSize, Sort.by(sortBy));

        List<ProspectoDto> prospectoDtos;
        prospectoDtos = prospectoMapper
                .prospectoToDto(prospectoRepository.findAll(paging).toList());

        return new ArrayList<>(prospectoDtos);
    }
