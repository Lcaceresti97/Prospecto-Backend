...
public class ProspectoController {
    ...
    public ProspectoController(ProspectoService prospectoServiceMock) {
        this.prospectoService = prospectoServiceMock;
    }

    @GetMapping("/allProspectos")
    public  ResponseEntity<? extends List<ProspectoDto>>  getAllProspectos(
            @RequestParam(defaultValue = "0") int pageNo,
            @RequestParam(defaultValue = "5") int pageSize,
            @RequestParam(defaultValue = "prospectoId") String sortBy)
    {
        List<ProspectoDto> list = prospectoService.getAllProspectos(pageNo, pageSize, sortBy);
